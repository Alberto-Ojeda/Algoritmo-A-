...
public class TableroGUI extends javax.swing.JPanel implements Runnable{
    ...
    public TableroGUI(int size, boolean tipo) {
        ...
        //circulo a hace ilusión al objeto muñeco  (3) donde utiliza el metodo draw para pintar
        //por lo que la clase circulo solo se implementa para eso y no tiene relación con el algoritmo
...
//      cuando inicializa el tablero es de tipo verdadero (4)
        ...
        cargarImagenes();
//se le pasa el tamaño de las casillas que sera el mismo que el tablero (5)
    ...
    //inicia el hilo no hay camino pero en realidad no es necesario ya que se checa antes de que inicie la animación
    //revisar la animación para ver que se puede implementar
